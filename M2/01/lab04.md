...
1.  In the Azure portal, select the **Cloud Shell** icon ![Cloud Shell icon](/M2/01/images/az204_lab_CloudShell.png) to open a new Bash session. If Cloud Shell defaults to a PowerShell session, select **PowerShell** and, in the drop-down menu, select **Bash**.
